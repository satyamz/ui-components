...
function (_React$Component) {
  _inherits(ShapeCircle, _React$Component);

  function ShapeCircle() {
    _classCallCheck(this, ShapeCircle);

    return _possibleConstructorReturn(this, _getPrototypeOf(ShapeCircle).apply(this, arguments));
  }

  _createClass(ShapeCircle, [{
    key: "render",
