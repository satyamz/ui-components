...
function (_React$Component) {
  _inherits(ShapeSquare, _React$Component);

  function ShapeSquare() {
    _classCallCheck(this, ShapeSquare);

    return _possibleConstructorReturn(this, _getPrototypeOf(ShapeSquare).apply(this, arguments));
  }

  _createClass(ShapeSquare, [{
    key: "render",
