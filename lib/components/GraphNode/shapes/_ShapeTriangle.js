...
function (_React$Component) {
  _inherits(ShapeTriangle, _React$Component);

  function ShapeTriangle() {
    _classCallCheck(this, ShapeTriangle);

    return _possibleConstructorReturn(this, _getPrototypeOf(ShapeTriangle).apply(this, arguments));
  }

  _createClass(ShapeTriangle, [{
    key: "render",
